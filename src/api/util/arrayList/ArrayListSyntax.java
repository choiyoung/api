...
/*
 java.utill.ArrayList 는 Object 배열을 이용해서
 데이터를 순차적으로 저장하는 공간.
 ...
 */
/*
 java.utill.Vector 과 차이점
 - 백터는 멀티스레드에 대한 동기화가 되어 있으나
 - java.utill.ArrayList 는 동기화가 되어 있지 않다.
 */
/*
 ArrayList 클래스
 ...
 2. 비 동기화 된 컬렉션은 동기화된 켈력션 보다 더 나은 성능을
